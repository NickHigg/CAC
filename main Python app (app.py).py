# This app is used to develop AI-powered housing price predictors on Streamlit
...
default_values = {
    ...
    # Add other non-essential features with default values if needed:
    # 'Year Built': 1970,
    # 'Mas Vnr Area': 100,
    # 'Overall Cond': 5,
}
...
if st.button("Predict Sale Price"):
    if model_choice == "Essential Features Model":
        ...
        # Load the default full model input file
        ...
        # Get prediction from the full-feature model
